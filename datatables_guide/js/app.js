...
$(document).ready(function () {
    ...
    data.forEach(element => {
        tableData.append(
            `<tr>
                <td>${element.formasi_id}</td>
                <td>${element.ins_nm}</td>
                <td>${element.jp_nama}</td>
                <td>${element.formasi_nm}</td>
                <td>${element.jabatan_nm}</td>
                <td>${element.lokasi_nm}</td>
                <td>${element.jumlah_formasi}</td>
                <td>${element.disable}</td>
                <td>${element.gaji_min}</td>
                <td>${element.gaji_max}</td>
            </tr>`);
    });
